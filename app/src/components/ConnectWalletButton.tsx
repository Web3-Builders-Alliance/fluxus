...
const ConnectWalletButton: React.FC<Props> = ({
  ...
  }, [connect, connected, onChildClick, onClose, onModalOpen, select]);
    ...
    <Box {...style}>
      ...
      >
        ...
        {isPhantom && connected && !children && (
          <PopoverContent background={"background.100"} maxWidth={160}>
            <PopoverBody
              display={"flex"}
      ...
      >
        <ModalOverlay />
        <ModalContent>
          <ModalHeader textAlign="center">Welcome to Fluxus</ModalHeader>
          <ModalBody>
